...
/**
 * payu enrolment plugin utility class.
 *
 * @package    enrol_payu
...
final class util {
     ...
     * @param stdClass $data    payu IPN data
     */
    public static function message_paypal_error_to_admin($subject, $data) {
        ...
        $eventdata->subject           = "payu ERROR: ".$subject;
    ...
    public static function get_exception_handler() {
        return function($ex) {
            ...
            $logerrmsg = "enrol_payu IPN exception handler: ".$info->message;
